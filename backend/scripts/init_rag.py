...
from db.database import DrinkKnowledge, SessionLocal, init_db
from knowledge.rag_store import sync_chroma_document
...
def init_knowledge_base():
    ...
    try:
        ...
        json_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "knowledge_base.json")
        if not os.path.exists(json_path):
            print("未找到 knowledge_base.json，跳过初始化。")
            return
